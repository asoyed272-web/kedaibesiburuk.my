...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    hero: {
      titlePart1: "Turn Your Scrap",
      titleHighlight: "Into Value",
      description: "We collect recyclable scrap from homes, shops, businesses and industries. Contact us today to arrange a convenient pickup.",
      requestPickupBtn: "Request Pickup",
      sellScrapBtn: "Sell Your Scrap",
      whatsappBtn: "WhatsApp Us",
      heroAlt: "Professional recycling and scrap collection truck",
    },
    trustBar: {
      easyPickupTitle: "Easy Pickup",
      easyPickupDesc: "We come to your location.",
      fairPricingTitle: "Fair Pricing",
      fairPricingDesc: "Prices based on material, quality and quantity.",
    ...
    contact: {
      ...
      phoneLabel: "Call",
      phoneDesc: "Call or message us anytime during business hours.",
      emailTitle: "Email",
      emailLabel: "Email",
      ...
      hoursWeekdays: "Monday–Saturday: 8:00 AM – 6:00 PM",
...
Please confirm the pickup schedule.`,
  ...
  ms: {
    ...
    hero: {
      titlePart1: "Tukarkan Barangan Lusuh",
      titleHighlight: "Kepada Wang",
      description: "Kami mengutip barangan kitar semula dari rumah, kedai, perniagaan dan industri. Hubungi kami hari ini untuk urusan kutipan yang mudah dan pantas.",
      requestPickupBtn: "Minta Kutipan",
      sellScrapBtn: "Jual Barangan Lusuh",
      whatsappBtn: "WhatsApp Kami",
      heroAlt: "Lori kutipan barangan lusuh dan kitar semula profesional",
    },
    trustBar: {
      easyPickupTitle: "Kutipan Mudah",
      easyPickupDesc: "Kami datang terus ke lokasi anda.",
      fairPricingTitle: "Harga Telus & Berpatutan",
      fairPricingDesc: "Harga berdasarkan jenis bahan, kualiti dan kuantiti.",
    ...
    contact: {
      ...
      phoneLabel: "Telefon",
      phoneDesc: "Hubungi atau hantar mesej kepada kami pada bila-bila masa waktu operasi.",
      emailTitle: "E-mel",
      emailLabel: "E-mel",
      ...
      hoursWeekdays: "Isnin–Sabtu: 8:00 PG – 6:00 PTG",
      hoursSunday: "Ahad: Tutup",
